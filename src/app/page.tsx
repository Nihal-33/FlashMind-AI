...
export default function LandingPage() {
  ...
  return (
    <div className="flex-grow flex flex-col relative overflow-hidden bg-slate-950 text-slate-300 selection:bg-primary/30 selection:text-white transition-colors duration-300 bg-grid">
      
      {/* Decorative Blur Orbs */}
      <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-primary/10 rounded-full blur-[120px] pointer-events-none opacity-60 dark:opacity-100 animate-float-slow" />
      <div className="absolute top-[40%] right-[-10%] w-[45%] h-[45%] bg-secondary/10 rounded-full blur-[120px] pointer-events-none opacity-60 dark:opacity-100 animate-float-reverse" />
      <div className="absolute bottom-[-10%] left-[20%] w-[50%] h-[50%] bg-accent/10 rounded-full blur-[120px] pointer-events-none opacity-60 dark:opacity-100 animate-float-slow" />

      {/* Navigation Header */}
      <header className="sticky top-0 z-50 bg-white/80 dark:bg-slate-950/80 border-b border-slate-200/50 dark:border-slate-800/40 backdrop-blur-md transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <Link href="/" className="flex items-center space-x-2.5 group">
            ...
            <span className="logo-text font-extrabold text-xl tracking-tight bg-gradient-to-r from-slate-900 via-slate-700 to-slate-500 dark:from-white dark:via-slate-200 dark:to-slate-400 bg-clip-text text-transparent">
              FlashMind <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">AI</span>
            </span>
          </Link>
          <nav className="hidden md:flex items-center space-x-8 text-sm font-medium text-slate-400 dark:text-slate-300">
          ...
          <div className="flex items-center gap-3.5">
            ...
            <button 
              onClick={toggleTheme}
              className="p-2 rounded-lg border border-slate-300 dark:border-white/10 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800/50 dark:hover:bg-slate-800 text-slate-400 hover:text-slate-200 transition cursor-pointer"
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col space-y-8 text-center lg:text-left">
            ...
            <motion.h1 
              ...
              className="text-4xl sm:text-5xl md:text-6xl font-extrabold leading-[1.1] tracking-tight text-slate-900 dark:text-white"
            >
            ...
            >
              ...
              >
                {user ? "Enter Dashboard" : "Generate Flashcards"}
          ...
          <div className="lg:col-span-5 relative flex items-center justify-center h-[400px]">
            ...
            >
              ...
              <h3 className="font-bold text-lg text-slate-200 mb-2 leading-snug">Neural Plasticity</h3>
              <p className="text-slate-400 text-xs leading-relaxed">
                The ability of the nervous system to change its activity in response to intrinsic or extrinsic stimuli.
              </p>
              <div className="mt-4 pt-3 border-t border-slate-200/50 dark:border-white/5 flex justify-between items-center">
            ...
            >
              ...
              <p className="text-slate-400 text-xs font-semibold mb-2">Review scheduled in:</p>
              <div className="text-2xl font-black text-slate-200 mb-3">6 Days</div>
              <div className="w-full bg-slate-200 dark:bg-slate-700/50 rounded-full h-1.5 mb-2">
      ...
      <div className="border-t border-b border-slate-200/60 dark:border-slate-800/30 bg-slate-100/40 dark:bg-slate-950/20 py-8 px-6 text-center">
      ...
      {/* Features Section */}
      <section id="features" className="py-24 px-6 relative bg-white dark:bg-slate-950">
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-3xl mx-auto mb-20 space-y-4">
            <span className="text-xs uppercase font-extrabold tracking-widest text-accent">Feature-rich Workspace</span>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 dark:text-white">Everything you need to master any subject</h2>
            <p className="text-slate-600 dark:text-slate-400">We combine the content generation of ChatGPT, the folder organization of Notion, and the scientific recall methods of Quizlet and Anki.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((f, i) => (
              <motion.div 
                key={i} 
                whileHover={{ y: -5 }}
                className="glass p-8 rounded-2xl border-slate-200/60 dark:border-white/5 hover:border-slate-300 dark:hover:border-white/10 transition-all flex flex-col justify-between"
              >
                <div className="space-y-4">
                  <div className="h-12 w-12 rounded-xl bg-slate-100 dark:bg-slate-800/80 flex items-center justify-center border border-slate-200/60 dark:border-white/10">
                    {f.icon}
                  </div>
      ...
      {/* Testimonials */}
      <section id="testimonials" className="py-20 bg-slate-100/40 dark:bg-slate-950/20 px-6 border-t border-slate-200/60 dark:border-slate-800/30">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 space-y-3">
            <span className="text-xs uppercase font-extrabold tracking-widest text-primary">Success Stories</span>
            <h2 className="text-3xl font-bold text-slate-900 dark:text-white">Loved by students worldwide</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((t, i) => (
              <div key={i} className="glass p-8 rounded-2xl flex flex-col justify-between relative border-slate-200/60 dark:border-white/5">
                <MessageSquare className="absolute top-4 right-4 h-5 w-5 text-slate-400 dark:text-slate-700 pointer-events-none" />
                <p className="text-slate-750 dark:text-slate-300 text-sm italic leading-relaxed mb-6">"{t.quote}"</p>
                <div>
      ...
      {/* Pricing Section */}
      <section id="pricing" className="py-24 px-6 relative border-t border-slate-200/60 dark:border-slate-800/30">
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-16 space-y-4">
            <span className="text-xs uppercase font-extrabold tracking-widest text-secondary">Pricing Plans</span>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 dark:text-white">Choose your learning speed</h2>
            <p className="text-slate-600 dark:text-slate-400">Unlock full capabilities. Start for free, upgrade when you need to study heavier textbooks.</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {/* Free Plan */}
            <div className="glass p-8 rounded-3xl border-slate-200/60 dark:border-white/5 flex flex-col justify-between">
              <div>
                <h3 className="font-bold text-xl text-slate-200 mb-2">Explorer Plan</h3>
              ...
              <Link 
                href={user ? "/dashboard" : "/login"}
                className="w-full py-3 bg-slate-200 hover:bg-slate-300 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-800 dark:text-white text-center font-bold rounded-xl transition"
              >
                Get Started
              </Link>
            </div>
            ...
            <div className="glass p-8 rounded-3xl border-primary/30 relative flex flex-col justify-between glow-primary">
              ...
              <div>
                <h3 className="font-bold text-xl text-slate-200 mb-2">Pro Scholar</h3>
                <p className="text-slate-400 text-xs mb-6">For students who want infinite generation and analytics.</p>
                <div className="flex items-baseline mb-6">
                  <span className="text-4xl font-extrabold text-slate-200">$9.99</span>
                  <span className="text-slate-400 text-sm ml-2">/ month</span>
                </div>
                <ul className="space-y-4 text-sm text-slate-300 mb-8">
                  <li className="flex items-center gap-2.5">
      ...
      {/* FAQ Section */}
      <section id="faq" className="py-24 px-6 border-t border-slate-200/60 dark:border-slate-800/30 bg-slate-100/10 dark:bg-slate-950/10">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            {faqs.map((faq, index) => (
              <div 
                key={index} 
                className="glass rounded-xl border-slate-200/60 dark:border-white/5 overflow-hidden transition-all duration-300"
              >
                <button
                  onClick={() => toggleFaq(index)}
                  className="w-full px-6 py-5 text-left flex items-center justify-between text-slate-200 font-semibold hover:bg-slate-100/50 dark:hover:bg-white/5 transition"
                >
                  <span>{faq.q}</span>
                  <ChevronDown className={`h-5 w-5 text-slate-500 dark:text-slate-400 transition-transform duration-300 ${activeFaq === index ? 'rotate-180' : ''}`} />
                </button>
                <div 
                  className={`transition-all duration-300 ease-in-out ${activeFaq === index ? 'max-h-48 border-t border-slate-200/60 dark:border-white/5 py-5 px-6 opacity-100' : 'max-h-0 opacity-0 pointer-events-none'}`}
                >
      ...
      {/* CTA Footer Block */}
      <section className="py-20 px-6 text-center border-t border-slate-200/60 dark:border-slate-800/30 bg-gradient-to-b from-slate-100 to-slate-200/50 dark:from-slate-900 dark:to-slate-950">
        <div className="max-w-3xl mx-auto space-y-8">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-200 leading-tight">Ready to boost your memory retention?</h2>
      ...
      {/* Footer */}
      <footer className="bg-slate-100 dark:bg-slate-950 py-12 px-6 border-t border-slate-200/60 dark:border-slate-800/30 text-slate-500 text-xs">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center space-x-2">
            ...
            <span className="font-extrabold text-sm text-slate-800 dark:text-slate-300">FlashMind AI</span>
          </div>
          <div>
            <p>&copy; 2026 FlashMind AI. Built with Next.js, Supabase, and DeepSeek. All rights reserved.</p>
          </div>
          <div className="flex space-x-6 text-slate-500 dark:text-slate-400 font-medium">
            ...
            <a href="#" className="hover:text-primary dark:hover:text-white transition">Contact Support</a>
          </div>
        </div>
      </footer>
